...
class SellTakeLockTest(PipelineBaseTest):
    def test_sell_make_and_take_order(self):
    ...
    def test_sell_make_and_take_range_order(self):
        trade = Trade(self.client, maker_form=maker_form_sell_with_range)
        trade.publish_order()
        trade.take_order()
        data = trade.response.json()
    ...
    def test_sell_make_and_take_description_order(self):
        description = "Test"
        description_maker_form = maker_form_sell_with_range.copy()
    ...
    def test_sell_make_and_take_password_order(self):
        password = "1234567"
        password_maker_form = maker_form_sell_with_range.copy()
    ...
    def test_sell_make_and_take_order_multiple_takers(self):
        trade = Trade(self.client, maker_form=maker_form_sell_with_range)
        trade.publish_order()
    ...
    def test_sell_make_and_lock_contract(self):
        trade = Trade(self.client, maker_form=maker_form_sell_with_range)
        trade.publish_order()
        trade.take_order()
    ...
    def test_sell_make_and_lock_contract_multiple_takers(self):
        trade = Trade(self.client, maker_form=maker_form_sell_with_range)
        trade.publish_order()
        trade.take_order()
        trade.take_order_third()
    ...
    def test_sell_trade_to_locked_escrow(self):
        trade = Trade(self.client, maker_form=maker_form_sell_with_range)
        trade.publish_order()
        trade.take_order()
        trade.take_order_third()
